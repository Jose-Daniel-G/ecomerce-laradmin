<div>
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                ...
                {{-- Manejo de Errores (Asegúrate de que tus errores de validación de Laravel sean visibles aquí) --}}
                @if ($errors->any())
    ...
    <form action="{{ route('admin.categories.destroy', $category) }}" id="delete-form" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
