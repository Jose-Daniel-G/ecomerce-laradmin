                    ...
                    <div class="row justify-content-center gx-2 gx-md-4">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <div
                                ...
                                <div class="feature_icon">
                                    <img loading="lazy"  src="{{ asset('template/assets/images/svg/delivery-van.svg')}}" alt="icon">
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <div
                                class="single_feature d-flex flex-column flex-sm-row align-items-center justify-content-center">
                                <div class="feature_icon">
                                    <img loading="lazy"  src="{{ asset('template/assets/images/svg/money-back.svg')}}" alt="icon">
                                </div>
                                <div class="feature_content">
                                    <h4>Money Returns</h4>
                        ...
                        <div class="col-sm-4">
                            <div
                                class="single_feature d-flex flex-column flex-sm-row align-items-center justify-content-center">
                                <div class="feature_icon">
                                    <img loading="lazy"  src="{{ asset('template/assets/images/svg/service-hours.svg')}}" alt="icon">
                                </div>
                                <div class="feature_content">
                                    <h4>24/7 Support</h4>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-6">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/apple-watch.png')}}" alt="product">
                            </a>
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/watch2.png')}}" alt="product">
                            </a>
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/watch3.png')}}" alt="product">
                            </a>
                ...
                <div class="col-xl-3 col-lg-4 col-6">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/phone-1.png')}}" alt="product">
                            </a>
                            <span class="tag">1</span>
                        </div>
                        <div class="topr_content">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/phone-2.png')}}" alt="product">
                            </a>
                            <span class="tag">2</span>
                        </div>
                        <div class="topr_content">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/phone-3.png')}}" alt="product">
                            </a>
                            <span class="tag">3</span>
                        </div>
                        <div class="topr_content">
                ...
                <div class="col-xl-3 col-lg-4 col-6">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/laptop-3.png')}}" alt="product">
                            </a>
                            <span class="tag">3</span>
                        </div>
                        <div class="topr_content">
                ...
                <div class="col-xl-3 col-lg-4 col-6 d-lg-none d-block d-xl-block">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/headphone-1.png')}}" alt="product">
                            </a>
                            <span class="tag">1</span>
                        </div>
                        <div class="topr_content">
                    ...
                    <div class="single_top_ranking">
                        <div class="topr_img">
                            <a href="product-view.html">
                                <img loading="lazy"  src="{{ asset('template/assets/images/headphone-3.png')}}" alt="product">
                            </a>
                            <span class="tag">3</span>
                        </div>
                        <div class="topr_content">
    ...
    {{-- <div class="ad_banner_area section_padding_b">
        <div class="container">
            <a href="#">
                ...
                <picture>
                    <source media="(min-width: 768px)" srcset="{{ asset('template/assets/images/offer-3.jpg')}}">
                    <img loading="lazy"  class="w-100" src="{{ asset('template/assets/images/offer-mobile-3.jpg')}}" alt="ad">
                </picture>
            </a>
        </div>
    </div> --}}
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        <div class="sna_img">
                            <img loading="lazy"  class="prd_img" src="{{ asset('template/assets/images/mouch-logi.png')}}" alt="product">
                            <div class="prodcut_hovcont">
                                <a href="javascript:void(0)" class="icon open_quickview" tabindex="0">
                                   <i class="icon-search-left"></i>
                                </a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        <div class="sna_img">
                            <img loading="lazy"  class="prd_img" src="{{ asset('template/assets/images/phone-2.png')}}" alt="product">
                            <div class="prodcut_hovcont">
                                <a href="javascript:void(0)" class="icon open_quickview" tabindex="0">
                                   <i class="icon-search-left"></i>
                                </a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        <div class="sna_img">
                            <img loading="lazy"  class="prd_img" src="{{ asset('template/assets/images/laptop-2.png')}}" alt="product">
                            <div class="prodcut_hovcont">
                                <a href="javascript:void(0)" class="icon open_quickview" tabindex="0">
                                   <i class="icon-search-left"></i>
                                </a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        <div class="sna_img">
                            <img loading="lazy"  class="prd_img" src="{{ asset('template/assets/images/coverpad.png')}}" alt="product">
                            <div class="prodcut_hovcont">
                                <a href="javascript:void(0)" class="icon open_quickview" tabindex="0">
                                   <i class="icon-search-left"></i>
                                </a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        <div class="sna_img">
                            <img loading="lazy"  class="prd_img" src="{{ asset('template/assets/images/headphone-2.png')}}" alt="product">
                            <div class="prodcut_hovcont">
                                <a href="javascript:void(0)" class="icon open_quickview" tabindex="0">
                                   <i class="icon-search-left"></i>
                                </a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                       <div class="download_left">
                        <img loading="lazy"  src="{{ asset('template/assets/images/mobile-view.png')}}" class="w-100">
                       </div>
                    </div>
                    <div class="col-lg-5 px-5 px-lg-0">
                        <div class="download_cont">
                            ...
                            <div class="download_links">
                                <a href="#" class="me-3">
                                    <img loading="lazy"  src="{{ asset('template/assets/images/download-1.png')}}" alt="download">
                                </a>
                                <a href="#">
                                    <img loading="lazy"  src="{{ asset('template/assets/images/download-2.png')}}" alt="download">
                                </a>
                            </div>
                        </div>
                    </div>
